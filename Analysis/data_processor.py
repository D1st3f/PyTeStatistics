...
class DataProcessor:
    ...
    def create_output_directory(subdirectory):
        ...
        output_directory = os.path.join(current_directory, '..', subdirectory,
    ...
    def read_from_csv(self):
        ...
        data_collection_directory = os.path.join(os.path.dirname(__file__),
                                                 '..',
                                                 'DataCollection')
    ...
    def plot_technology_mentions(self, threshold: int = 5):
        ...
        ax.bar(tech_counts['Technology'], tech_counts['Mentions'],
               color='deepskyblue')
    ...
    def plot_experience_distribution(self):
        ...
        fig, ax = plt.subplots(figsize=(14, 6))
        ax.bar(experience_df['Experience'], experience_df['Count'],
               color='lightcoral')
    ...
    def plot_postings_per_day(self):
        ...
        fig, ax = plt.subplots(figsize=(14, 6))
        ax.bar(day_of_week_df['Day of Week'], day_of_week_df['Count'],
               color='skyblue')
